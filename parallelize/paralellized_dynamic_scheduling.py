...
if __name__ == '__main__':
    ...
    for num_proc in num_procs_list:
      ...
      chunk_size = 1 # Each worker gets one floorplan at a time and asks for another when done
    ...
    print('Speedups for processes', num_procs_list, speedups)
    ...
    plt.savefig('speedup_dynamic_scheduling.png', dpi=300, bbox_inches='tight')
    plt.close()
